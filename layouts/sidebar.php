    ...
    <ul class="list-unstyled components">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/modules/cabang') !== false || strpos($_SERVER['REQUEST_URI'], '/modules/users') !== false ? 'show' : '' ?>" id="supervisiMenu">
                <li><a href="/modules/cabang/index.php">Manajemen Cabang</a></li>
                <li><a href="/modules/users/index.php">Manajemen Petugas (Users)</a></li>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/pembayaran/') !== false ? 'show' : '' ?>" id="pembayaranMenu">
                <li><a href="/modules/pembayaran/member.php">Pembayaran Member</a></li>
                <li><a href="/modules/pembayaran/ruko.php">Pembayaran Ruko</a></li>
                <li><a href="/modules/pembayaran/pedagang.php">Pembayaran Pedagang</a></li>
            </ul>
        </li>
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/pemasukan/') !== false ? 'show' : '' ?>" id="pemasukanMenu">
                <li><a href="/modules/pemasukan/parkir.php">Pendapatan Parkir</a></li>
                <li><a href="/modules/pemasukan/lain.php">Pendapatan Lain</a></li>
            </ul>
        </li>
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/pengeluaran/') !== false ? 'show' : '' ?>" id="pengeluaranMenu">
                <li><a href="/modules/pengeluaran/index.php">Daftar Pengeluaran</a></li>
                <li><a href="/modules/pengeluaran/kategori.php">Kategori Pengeluaran</a></li>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/modules/karyawan') !== false || strpos($_SERVER['REQUEST_URI'], '/modules/penggajian') !== false ? 'show' : '' ?>" id="hrisMenu">
                <li><a href="/modules/karyawan/index.php">Database Karyawan</a></li>
                <li><a href="/modules/karyawan/absensi.php">Absensi Karyawan</a></li>
                <li><a href="/modules/karyawan/pinjaman.php">Kasbon & Pinjaman</a></li>
                <li><a href="/modules/penggajian/index.php">Penggajian Bulanan</a></li>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/modules/member') !== false || strpos($_SERVER['REQUEST_URI'], '/modules/ruko') !== false || strpos($_SERVER['REQUEST_URI'], '/modules/pedagang') !== false || strpos($_SERVER['REQUEST_URI'], '/modules/ojek') !== false ? 'show' : '' ?>" id="masterDataMenu">
                <?php if(in_array($_SESSION['user']['role'], ['Super Admin', 'Admin', 'HRD'])): ?>
                <li><a href="/modules/member/index.php">Data Member</a></li>
                <?php endif; ?>
                <li><a href="/modules/ruko/index.php">Data Ruko</a></li>
                <li><a href="/modules/pedagang/index.php">Data Pedagang</a></li>
                <li><a href="/modules/ojek/index.php">Data Ojek Online</a></li>
            </ul>
        </li>
        <?php endif; ?>
        ...
        <li>
            ...
            <ul class="collapse list-unstyled <?= strpos($_SERVER['REQUEST_URI'], '/laporan/') !== false ? 'show' : '' ?>" id="laporanMenu">
                <li><a href="/modules/laporan/harian.php" >Laporan Kas Harian</a></li>
                <li><a href="/modules/laporan/pembayaran.php">Laporan Pembayaran</a></li>
                <li><a href="/modules/laporan/tunggakan.php">Laporan Tunggakan</a></li>
                <li><a href="/modules/laporan/jatuh_tempo.php">Laporan Jatuh Tempo</a></li>
                <li><a href="/modules/laporan/pemasukan.php">Laporan Laba/Rugi</a></li>
            </ul>
        </li>
        <?php endif; ?>
    </ul>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu shadow border-0" aria-labelledby="branchMenu">
                        ...
                        <li>
                            <form method="POST" action="/switch_cabang.php">
